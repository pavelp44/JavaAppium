...
public class Platform {
    ...
    public RemoteWebDriver getDriver() throws Exception{
        ...
        if (this.isAndroid()) return new AndroidDriver(URL, this.getAndroidDesiredCapabilities());
            ...
            System.setProperty("webdriver.chrome.driver","/Users/pavel/Documents/chromedriver");
            return new ChromeDriver(this.getMWChromeOptions());
        }
        else throw new Exception("Cannot detect type of a Driver. Platform value is " + this.getPlatformVar());
    }
    ...
    private DesiredCapabilities getIOSDesiredCapabilities() throws Exception {
        ...
        capabilities.setCapability("app", "/Users/pavel/IdeaProjects/JavaAutomationCourse/JavaAppiumAutomationTasks/apks/Wikipedia.app");
        return capabilities;
    }
